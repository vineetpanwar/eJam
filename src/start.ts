...
const deploymentRouter = require("./routes/deploymentRoutes.ts");
...
app.use(express.static(__dirname + "/public/client/ejam/build"));

app.get("*", (req: any, res: any) => {
  res.sendFile(
    path.join(__dirname, "public", "client", "ejam", "build", "index.html")
  );
});
